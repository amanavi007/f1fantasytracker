  ...
  return (
    <div className="space-y-6">
      <section className="rounded-2xl border border-border/70 bg-black/25 p-6 shadow-race">
        ...
        <h1 className="mt-2 font-display text-4xl tracking-[0.08em] text-white">Private League Punishment Tracker</h1>
      ...
      <section className="grid gap-4 xl:grid-cols-2">
        <Card>
          ...
          <CardDescription className="mt-1">Track status, review workload, and lock when clean.</CardDescription>
